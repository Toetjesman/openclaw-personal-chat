...
export const en: TranslationMap = {
  ...
  chat: {
    ...
    sidebar: {
      ...
      finishActiveRun: "Finish the active run before creating a new session",
      allChats: "All chats",
      history: "Chat history",
      searchingHistory: "Searching chat history...",
      noChatsFound: "No chats found",
      noHistory: "No chat history yet",
      loading: "Loading...",
      loadMore: "Load more",
      allLoaded: "All loaded",
      loadedCountPlus: "{count}+ loaded",
      chatCount: "{count} chats",
      searchAllChats: "Search all chats",
      searchHelp: "Search looks through titles and loaded chat content.",
      loadMoreChats: "Load more chats",
      allChatsLoaded: "All chats loaded",
      noDate: "No date",
      activeRun: "Active run",
      deleteConfirmOne: "session",
      deleteConfirmMany: "sessions",
      deleteConfirm:
