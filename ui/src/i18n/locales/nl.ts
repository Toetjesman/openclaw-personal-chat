...
export const nl: TranslationMap = {
  ...
  chat: {
    ...
    welcome: {
      ...
      hintBeforeShortcut: "Typ hieronder een bericht ·",
      hintAfterShortcut: "voor opdrachten",
      suggestions: {
        whatCanYouDo: "Wat kun je doen?",
        summarizeRecentSessions: "Vat mijn recente sessies samen",
        configureChannel: "Help me een kanaal configureren",
        checkSystemHealth: "Controleer de systeemstatus",
      },
    },
    runControls: {
      newSession: "Nieuwe sessie",
      ...
      queue: "Wachtrij",
      queueMessage: "Bericht in wachtrij zetten",
      stop: "Stop",
    ...
    sidebar: {
      connectToCreate: "Maak verbinding om een nieuwe sessie te starten",
      finishActiveRun: "Wacht tot de actieve run klaar is voordat je een nieuwe sessie start",
      allChats: "Alle chats",
      history: "Chatgeschiedenis",
      searchingHistory: "Chatgeschiedenis doorzoeken...",
      noChatsFound: "Geen chats gevonden",
      noHistory: "Nog geen chatgeschiedenis",
      loading: "Laden...",
      loadMore: "Meer laden",
      allLoaded: "Alles geladen",
      loadedCountPlus: "{count}+ geladen",
      chatCount: "{count} chats",
      searchAllChats: "Zoek in alle chats",
      searchHelp: "Zoeken kijkt in titels en geladen chatinhoud.",
      loadMoreChats: "Meer chats laden",
      allChatsLoaded: "Alle chats geladen",
      noDate: "Geen datum",
      activeRun: "Actieve run",
      deleteConfirmOne: "sessie",
      deleteConfirmMany: "sessies",
      deleteConfirm:
        "{count} {item} verwijderen?\n\nDit verwijdert de sessievermeldingen en archiveert de transcripts.",
    },
    queue: {
      retry: "Opnieuw proberen",
    ...
    composer: {
      placeholder: "Bericht aan {name} (Enter om te verzenden)",
      placeholderWithAttachments: "Voeg een bericht toe of plak meer afbeeldingen...",
      placeholderDisconnected: "Maak verbinding met de Gateway om te chatten...",
      attachFile: "Bestand bijvoegen",
      startTalk: "Gesprek starten",
      stillListening: "Luistert nog",
      talkTranscript: "Gesprekstranscript",
      stopTalk: "Gesprek stoppen",
    },
    selectors: {
      ...
      model: "Chatmodel",
      thinkingLevel: "Denkniveau voor chat",
    },
  },
  languages: {
    en: "English (Engels)",
